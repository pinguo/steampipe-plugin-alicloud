...
func Plugin(ctx context.Context) *plugin.Plugin {
	p := &plugin.Plugin{
		...
		TableMap: map[string]*plugin.Table{
			...
			"alicloud_alb_load_balancer":                          tableAlicloudAlbLoadBalancer(ctx),
			"alicloud_alb_server_group":                           tableAlicloudAlbServerGroup(ctx),
			"alicloud_alb_server_group_server":                    tableAlicloudAlbServerGroupServer(ctx),
			...
			"alicloud_cas_certificate_order":                      tableAlicloudCasCertificateOrder(ctx),
			"alicloud_ccc_instance":                               tableAlicloudCccInstance(ctx),
			...
			"alicloud_security_center_asset":                      tableAlicloudSecurityCenterAsset(ctx),
			"alicloud_security_center_field_statistics":           tableAlicloudSecurityCenterFieldStatistics(ctx),
			"alicloud_security_center_vulnerability":              tableAlicloudSecurityCenterVulnerability(ctx),
			...
			"alicloud_swas_instance":                              tableAlicloudSwasInstance(ctx),
			"alicloud_swas_disk":                                  tableAlicloudSwasDisk(ctx),
			"alicloud_log_store":                                  tableAlicloudLogStore(ctx),
